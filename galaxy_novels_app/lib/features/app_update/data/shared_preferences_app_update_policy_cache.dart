...
class SharedPreferencesAppUpdatePolicyCache implements AppUpdatePolicyCache {
  SharedPreferencesAppUpdatePolicyCache({SharedPreferencesAsync? preferences})
    : _preferences = preferences;

  static const key = 'app_update_policy.v1';
