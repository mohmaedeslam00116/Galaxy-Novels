...
تأتي بعد استقرار الجلسة والمزامنة. فصول VIP للقراءة فقط منفذة الآن: القائمة وحالة الحساب وفتح الفصل داخل القارئ Native تعمل عبر مسار القالب الجديد. سياسة كاش VIP القصير والتنزيلات والدفع مؤجلة. نظام النقاط والإعلانات ليس جزءا من هذه المرحلة تلقائيا.

## الخطوة التالية مباشرة

بعد إغلاق قراءة VIP الأساسية، الخطوة التالية الأقرب هي اختيار مسار جديد من الفجوات غير المنفذة: مجلدات المستخدم داخل app namespace، أو إحصائيات/تعديل حسابي، أو register/password APIs.
