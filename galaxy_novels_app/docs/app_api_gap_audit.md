...
الخطوة التالية الأقرب في VIP هي إضافة مسار `GET /wp-json/wor-reader-app/v1/vip/chapter?chapter_id=ID` في القالب حتى يمكن فتح أول فصل VIP مباشرة داخل القارئ Native.
