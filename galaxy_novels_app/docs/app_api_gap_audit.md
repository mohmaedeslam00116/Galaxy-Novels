...
ندمج سجل القراءة المحلي مع `GET /me/history` و`GET /me/history/novel/{id}` من دون فقدان أحدث تقدم، ثم نبني queue لأحداث القراءة ونرسلها على دفعات إلى `POST /reading/sync`.
