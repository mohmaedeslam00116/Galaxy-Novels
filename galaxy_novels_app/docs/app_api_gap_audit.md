...
3. تجربة التسجيل واستعادة كلمة المرور يمكن أن تفتح صفحات ويب رسمية مؤقتا حتى تتوفر endpoints مخصصة.
...
بعد نقطة الاستقرار الحالية، الخطوة التالية الأقرب هي تحسين دورة الحساب: إنشاء حساب أو فتح صفحة التسجيل الرسمية، استعادة كلمة المرور، توضيح انتهاء الجلسة، ثم بحث إمكانية تعديل الاسم والصورة أو عرضها من app namespace موحد.
