...
نبدأ بيانات المستخدم بالمفضلة: نجلب `GET /me/favorites`، نحتفظ بالتغييرات محليا عند انقطاع الشبكة، ثم نرسلها مجمعة عبر `POST /me/favorites/sync`. بعد ذلك ندمج سجل القراءة المحلي والبعيد.
