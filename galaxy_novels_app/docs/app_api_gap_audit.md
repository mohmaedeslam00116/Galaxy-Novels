...
1. تفعيل وجهات Drawer أو إخفاء غير الجاهز منها؛ حسابي وإعدادات القراءة يعملان، وبقية الوجهات تغلق القائمة دون نتيجة.
2. مدير التنزيل يستمر عند التنقل داخل التطبيق، لكنه لا يستعيد مهمة شبكة جارية بعد قتل عملية التطبيق أو إعادة تشغيل الهاتف.
3. اختيار ثيم التطبيق مجهز بالتوكنز فقط، ولا توجد شاشة أو persistence بعد.
...
نراجع وجهات القائمة الجانبية غير الجاهزة: المفضلة وVIP وحول التطبيق، ثم نفعل ما يمكن تنفيذه محليا ونخفي ما يعتمد على مراحل الحساب والاشتراك.
