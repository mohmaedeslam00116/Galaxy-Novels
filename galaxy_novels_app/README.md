...
تطبيق Flutter عربي لقراءة روايات `galaxynovels.com` بواجهة Native وقارئ فصول دون WebView. يدعم الحسابات والمفضلة المتزامنة، ويدمج أحدث موضع قراءة محلي مع سجل الحساب، ويحفظ نشاط القراءة ويرسله عند عودة الاتصال. بعد المزامنة يحدث XP والرتبة من السيرفر دون احتسابهما محليا.
