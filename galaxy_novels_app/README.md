...
تطبيق Flutter عربي لقراءة روايات `galaxynovels.com` بواجهة Native وقارئ فصول دون WebView. يدعم الحسابات والمفضلة المتزامنة، مع حفظ تغييرات المفضلة محليا عند انقطاع الاتصال.
