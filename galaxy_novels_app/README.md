...
تطبيق Flutter عربي لقراءة روايات `galaxynovels.com` بواجهة Native وقارئ فصول دون WebView. يدعم الحسابات والمفضلة المتزامنة، ويدمج أحدث موضع قراءة محلي مع سجل الحساب مع استمرار العمل عند انقطاع الاتصال.
